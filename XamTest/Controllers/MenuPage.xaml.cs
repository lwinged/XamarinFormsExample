...
namespace XamTest
{
	public partial class MenuPage : ContentPage
	{
		...
		public MenuPage ()
		{
			...
			list.Add(new MasterPageItem { Title = "Xamarin", TargetType = typeof(XamarinListViewPage) });
			list.Add(new MasterPageItem { Title = "Flow", TargetType = typeof(FlowListViewPage) });
